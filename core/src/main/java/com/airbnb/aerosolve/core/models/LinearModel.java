...
import com.airbnb.aerosolve.core.perf.SparseVector;
...
public class LinearModel extends AbstractModel {
  ...
  @Getter
  protected Reference2DoubleMap<Feature> weights;
  ...
  public void save(BufferedWriter writer) throws IOException {
    ...
    writer.newLine();
    for (Reference2DoubleMap.Entry<Feature> entry : weights.reference2DoubleEntrySet()) {
      Feature feature = entry.getKey();

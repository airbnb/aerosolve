...
public class SplineModel extends AbstractModel {
  ...
  @Getter @Setter
  private Reference2ObjectMap<Feature, WeightSpline> weightSpline;
  ...
  // Adds a new spline
  public void addSpline(String family, String featureName, double minVal, double maxVal,
                        boolean overwrite) {

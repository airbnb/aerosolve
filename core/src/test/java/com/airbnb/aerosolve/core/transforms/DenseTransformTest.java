...
public class DenseTransformTest {
  ...
  // TODO (Brad): Talk to Julian and make sure we really need this transform
  // If we have .denseArray on MultiFamilyVector, can we achieve the same thing with a
  // MoveTransform that puts the right features in the family and denseArray()?

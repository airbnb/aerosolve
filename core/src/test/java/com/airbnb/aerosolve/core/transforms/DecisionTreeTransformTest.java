...
public class DecisionTreeTransformTest extends BaseTransformTest {
  ...
  // TODO (Brad): From what I can tell, the old test worked because the float features were null.
  // But that's a side effect of an empty vector.  An empty vector with an empty float features map
  // would create a non-empty result. . .
  @Override

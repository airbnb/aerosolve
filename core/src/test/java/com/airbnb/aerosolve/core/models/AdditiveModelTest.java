...
public class AdditiveModelTest {
  ...
  AdditiveModel makeAdditiveModel() {
    ...
    Reference2ObjectMap<Feature, Function> weights = model.getWeights();
  ...
  public void testLoad() {
    ...
    record4.setFunctionForm(FunctionForm.SPLINE);
    ...
    record5.setFunctionForm(FunctionForm.SPLINE);
    ...
    try {
      ...
      assertEquals(8.0d + 10.0d + 15.0d, score, 0.001f);
    } catch (IOException e) {
  ...
  public void testAddFunction() {
    ...
    double[] newSplineParams = {2.0d, 10.0d, 5.0d}; // minVal, maxVal, numBins
    double[] newLinearParams = {3.0d, 5.0d}; // minVal, maxVal

package com.airbnb.aerosolve.core.transform;

import com.airbnb.aerosolve.core.Example;
import com.airbnb.aerosolve.core.FeatureVector;
import com.airbnb.aerosolve.core.transforms.Transform;
import com.airbnb.aerosolve.core.transforms.TransformFactory;
...
public class Transformer implements Serializable {
  ...
  public void addContextToItemAndTransform(Map<String, Set<String>> contextStringFeatures,
    ...
    if (contextStringFeatures != null) {
      ...
      for (Entry<String, Set<String>> stringFeature : contextStringFeatures.entrySet()) {
    ...
    if (contextFloatFeatures != null) {
      ...
      for (Entry<String, Map<String, Double>> floatFeature : contextFloatFeatures.entrySet()) {
    ...
    if (contextDenseFeatures != null) {
      ...
      for (Entry<String, List<Double>> denseFeature : contextDenseFeatures.entrySet()) {
